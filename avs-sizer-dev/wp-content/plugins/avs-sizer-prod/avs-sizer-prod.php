<?php
/**
 * Plugin Name: Azure VMware Solution Sizer - Prod Version
 * Plugin URI: https://dinocloud.net/avs-sizer
...
function avs_sizer_shortcode_prod() {
    ob_start(); ?>
...
add_shortcode('avs_sizer_prod', 'avs_sizer_shortcode_prod');
